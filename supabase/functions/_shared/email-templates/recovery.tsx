...
export const RecoveryEmail = ({ siteName, confirmationUrl }: RecoveryEmailProps) => (
  <Html lang="pt-BR" dir="ltr">
    <Head />
    <Preview>Redefinir sua senha — Gerenciar Frotas</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>Recebemos uma solicitação para redefinir a senha da sua conta no Gerenciar Frotas. Clique no botão abaixo para criar uma nova senha.</Text>
        <Button style={button} href={confirmationUrl}>Redefinir Senha</Button>
        <Text style={footer}>Se você não solicitou a redefinição de senha, ignore este e-mail. Sua senha não será alterada.</Text>
      </Container>
    </Body>
  </Html>
)
